        ...
        <div class="card-body">
            ...
            <form action="{{ route('reviews.update', $review->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name_reviewer" id="name_reviewer" class="form-control" value="{{ $review->name_reviewer }}" required>
                </div>

                <div class="mb-3">
                    <label for="email_reviewer" class="form-label">Email Recensore</label>
                    <input type="email" name="email_reviewer" id="email_reviewer" class="form-control" value="{{ $review->email_reviewer }}" required>
                </div>
