...
class DoctorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Genera lo slug in minuscolo con un numero randomico
        $slugBase = Str::slug($data['surname'], '-');
        $uniqueSlug = $slugBase . '-' . rand(1000, 9999); // Aggiunge un numero randomico per l'unicità
        $data['slug'] = $uniqueSlug;

        // Debug: Controlla i dati prima della creazione
        $doctor = Doctor::create($data);
        dd($doctor); // Verifica che lo slug sia presente e corretto
    ...
    public function update(Request $request, Doctor $doctor)
    {
        ...
        // Genera lo slug in minuscolo con un numero randomico
        $slugBase = Str::slug($request->input('surname'), '-');
        $uniqueSlug = $slugBase . '-' . rand(1000, 9999); // Aggiunge un numero randomico per l'unicità
        $data['slug'] = $uniqueSlug;
